...
class BookingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('booking_from', 'create')
            ->notEmpty('booking_from');

        $validator
            ->requirePresence('booking_to', 'create')
            ->notEmpty('booking_to');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['booker_id'], 'Users'));
    ...
    public function afterSave($created, $options = array()) {
        if ($created) {
            ...
            $event = new Event('Model.Booking.created', $this, $options);
